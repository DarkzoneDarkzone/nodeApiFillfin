...
class ViewService extends dbconnect_1.DBconnect {
    constructor() {
        ...
        this.query_product_recommend = (package_id, sex) => __awaiter(this, void 0, void 0, function* () {
            sql = ` SELECT view_product.*, GROUP_CONCAT(view_product.path_img) as product_img
        ...
        this.query_product_preorder = (package_id, sex, store_id) => __awaiter(this, void 0, void 0, function* () {
            sql = ` SELECT view_product.*, GROUP_CONCAT(view_product.path_img) as product_img
                FROM view_product WHERE package_id = ? AND sex = ? AND store_id = ? AND pre_order = "yes"
                GROUP BY view_product.store_id, view_product.id ORDER BY RAND()`;
            return this.findAll(sql, [package_id, sex, store_id]);
        });
        this.query_store_post = (store_id) => __awaiter(this, void 0, void 0, function* () {
            sql = `SELECT * FROM 
        ...
        this.query_product_incart = (member_id) => __awaiter(this, void 0, void 0, function* () {
            sql = `SELECT * FROM 
                    (SELECT products.*, 
        ...
        this.query_member_order = (member_id) => __awaiter(this, void 0, void 0, function* () {
            sql = `SELECT * FROM 
        ...
        this.query_store_order = (store_id) => __awaiter(this, void 0, void 0, function* () {
            sql = `SELECT * FROM 
                    (SELECT order_number, payment_status, status, totalprice, netprice, member_id, createdAt,
        ...
        this.query_admin_order = () => __awaiter(this, void 0, void 0, function* () {
            sql = `SELECT * FROM 
                    (SELECT order_number, payment_status, status, totalprice, netprice, member_id, createdAt,
        ...
        this.query_order_one = (order_number, product_id) => __awaiter(this, void 0, void 0, function* () {
            sql = `SELECT * FROM 
                    (SELECT orders.*,
                        orders_address.name,
                        orders_address.address,
        ...
        this.queryReviewForMember = (store_id) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.queryChatMember = () => __awaiter(this, void 0, void 0, function* () {
            sql = `SELECT * FROM (
                    SELECT chat_temp.*, 
                        members.username, 
        ...
        this.queryPositionAll = () => __awaiter(this, void 0, void 0, function* () {
            sql = `SELECT position FROM ads GROUP BY position`;
            return this.findAll(sql, []);
        });
        this.queryAdsShow = (page) => __awaiter(this, void 0, void 0, function* () {
